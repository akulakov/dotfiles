...
if !exists("no_plugin_maps") && !exists("no_gtd_maps")
    noremap  <silent> <LocalLeader>gn	:GtdNewTask<CR>
    noremap  <silent> <LocalLeader>gd	:GtdMarkDone<CR>
    noremap  <silent> <LocalLeader>gc	:GtdAddContext<CR>
    noremap  <silent> <LocalLeader>gp	:GtdAssignProject<CR>
    noremap  <silent> <LocalLeader>gs	:GtdSort<CR>
endif
